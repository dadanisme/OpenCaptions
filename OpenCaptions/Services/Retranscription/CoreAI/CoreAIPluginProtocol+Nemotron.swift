...
//  CoreAIPlugin/Sources/CoreAIPlugin/CoreAIPluginProtocol+Nemotron.swift — see
//  CoreAIPluginProtocol.swift's header for why there are two copies and why
//  the explicit @objc(...) names on both the protocols and their methods
...
@objc(CoreAINemotronTranscriptionPlugin) protocol CoreAINemotronTranscriptionPlugin: NSObjectProtocol {
...
@objc(CoreAINemotronSession) protocol CoreAINemotronSession: NSObjectProtocol {
